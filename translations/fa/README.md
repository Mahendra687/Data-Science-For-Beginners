# علم داده برای مبتدی‌ها - یک برنامه درسی
...
|:---:|
| علم داده برای مبتدی‌ها - _یادداشت تصویری توسط [@nitya](https://twitter.com/nitya)_ |
...
|:---:|
| داده‌کاوی برای مبتدیان: نقشه راه - _یادداشت تصویری توسط [@nitya](https://twitter.com/nitya)_ |
