...
```
![chiều dài tối đa theo bộ](../../../../../translated_images/vi/max-length-per-order.e5b283d952c78c12.webp)
...
```
![phân bố trên toàn bộ bộ dữ liệu](../../../../../translated_images/vi/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![phân bố-30bins](../../../../../translated_images/vi/distribution-30bins.6a3921ea7a421bf7.webp)
...
![biểu đồ histogram đã lọc](../../../../../translated_images/vi/filtered-histogram.6bf5d2bfd8253322.webp)
...
![biểu đồ 2d](../../../../../translated_images/vi/2d-plot.c504786f439bd7eb.webp)
...
![sải cánh và tình trạng bảo tồn](../../../../../translated_images/vi/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![biểu đồ mật độ](../../../../../translated_images/vi/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![mật độ khối lượng cơ thể](../../../../../translated_images/vi/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![khối lượng cơ thể ít mượt hơn](../../../../../translated_images/vi/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![khối lượng cơ thể theo bộ](../../../../../translated_images/vi/bodymass-per-order.9d2b065dd931b928.webp)
