...
```
![максимальная длина по отрядам](../../../../../translated_images/ru/max-length-per-order.e5b283d952c78c12.webp)
...
```
![распределение по всему набору данных](../../../../../translated_images/ru/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![распределение-30 интервалов](../../../../../translated_images/ru/distribution-30bins.6a3921ea7a421bf7.webp)
...
![отфильтрованная гистограмма](../../../../../translated_images/ru/filtered-histogram.6bf5d2bfd8253322.webp)
...
![2D диаграмма](../../../../../translated_images/ru/2d-plot.c504786f439bd7eb.webp)
...
![размах крыльев и статус сохранности](../../../../../translated_images/ru/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![плотностный график](../../../../../translated_images/ru/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![плотность массы тела](../../../../../translated_images/ru/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![менее плавная масса тела](../../../../../translated_images/ru/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![масса тела по отрядам](../../../../../translated_images/ru/bodymass-per-order.9d2b065dd931b928.webp)
