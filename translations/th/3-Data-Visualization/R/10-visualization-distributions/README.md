...
```
![ความยาวสูงสุดต่ออันดับ](../../../../../translated_images/th/max-length-per-order.e5b283d952c78c12.webp)
...
```
![การกระจายตัวในชุดข้อมูลทั้งหมด](../../../../../translated_images/th/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![การกระจายตัว-30bins](../../../../../translated_images/th/distribution-30bins.6a3921ea7a421bf7.webp)
...
![ฮิสโตแกรมที่กรองแล้ว](../../../../../translated_images/th/filtered-histogram.6bf5d2bfd8253322.webp)
...
![แผนภูมิ 2 มิติ](../../../../../translated_images/th/2d-plot.c504786f439bd7eb.webp)
...
![การเปรียบเทียบความกว้างปีกและสถานะการอนุรักษ์](../../../../../translated_images/th/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![แผนภูมิความหนาแน่น](../../../../../translated_images/th/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![ความหนาแน่นของมวลร่างกาย](../../../../../translated_images/th/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![มวลร่างกายที่ราบรื่นน้อยลง](../../../../../translated_images/th/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![มวลร่างกายต่ออันดับ](../../../../../translated_images/th/bodymass-per-order.9d2b065dd931b928.webp)
