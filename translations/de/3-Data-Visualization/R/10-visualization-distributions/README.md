...
```
![max Länge pro Ordnung](../../../../../translated_images/de/max-length-per-order.e5b283d952c78c12.webp)
...
```
![Verteilung über den gesamten Datensatz](../../../../../translated_images/de/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![Verteilung-30bins](../../../../../translated_images/de/distribution-30bins.6a3921ea7a421bf7.webp)
...
![gefiltertes Histogramm](../../../../../translated_images/de/filtered-histogram.6bf5d2bfd8253322.webp)
...
![2D-Diagramm](../../../../../translated_images/de/2d-plot.c504786f439bd7eb.webp)
...
![Flügelspannweite und Schutzstatus](../../../../../translated_images/de/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![Dichteplot](../../../../../translated_images/de/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![Körpermasse-Dichte](../../../../../translated_images/de/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![weniger glatte Körpermasse](../../../../../translated_images/de/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![Körpermasse pro Ordnung](../../../../../translated_images/de/bodymass-per-order.9d2b065dd931b928.webp)
