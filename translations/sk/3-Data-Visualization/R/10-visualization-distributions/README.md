...
```
![max dĺžka podľa radu](../../../../../translated_images/sk/max-length-per-order.e5b283d952c78c12.webp)
...
```
![distribúcia pre celý dataset](../../../../../translated_images/sk/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![distribúcia-30bins](../../../../../translated_images/sk/distribution-30bins.6a3921ea7a421bf7.webp)
...
![filtrovaný histogram](../../../../../translated_images/sk/filtered-histogram.6bf5d2bfd8253322.webp)
...
![2d graf](../../../../../translated_images/sk/2d-plot.c504786f439bd7eb.webp)
...
![rozpätie krídel a stav ochrany](../../../../../translated_images/sk/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![hustotný graf](../../../../../translated_images/sk/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![hustota telesnej hmotnosti](../../../../../translated_images/sk/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![menej hladká telesná hmotnosť](../../../../../translated_images/sk/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![telesná hmotnosť podľa radu](../../../../../translated_images/sk/bodymass-per-order.9d2b065dd931b928.webp)
