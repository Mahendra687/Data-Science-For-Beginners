...
```
![maksymalna długość na rząd](../../../../../translated_images/pl/max-length-per-order.e5b283d952c78c12.webp)
...
```
![rozkład dla całego zbioru danych](../../../../../translated_images/pl/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![rozkład-30przedziałów](../../../../../translated_images/pl/distribution-30bins.6a3921ea7a421bf7.webp)
...
![przefiltrowany histogram](../../../../../translated_images/pl/filtered-histogram.6bf5d2bfd8253322.webp)
...
![wykres 2D](../../../../../translated_images/pl/2d-plot.c504786f439bd7eb.webp)
...
![rozpiętość skrzydeł i status ochrony](../../../../../translated_images/pl/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![wykres gęstości](../../../../../translated_images/pl/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![gęstość masy ciała](../../../../../translated_images/pl/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![mniej płynna masa ciała](../../../../../translated_images/pl/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![masa ciała na rząd](../../../../../translated_images/pl/bodymass-per-order.9d2b065dd931b928.webp)
