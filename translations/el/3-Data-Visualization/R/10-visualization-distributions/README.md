...
```
![μέγιστο μήκος ανά τάξη](../../../../../translated_images/el/max-length-per-order.e5b283d952c78c12.webp)
...
```
![κατανομή σε όλο το σύνολο δεδομένων](../../../../../translated_images/el/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![κατανομή-30 κάδοι](../../../../../translated_images/el/distribution-30bins.6a3921ea7a421bf7.webp)
...
![φιλτραρισμένο ιστόγραμμα](../../../../../translated_images/el/filtered-histogram.6bf5d2bfd8253322.webp)
...
![2d διάγραμμα](../../../../../translated_images/el/2d-plot.c504786f439bd7eb.webp)
...
![άνοιγμα φτερών και κατάσταση διατήρησης](../../../../../translated_images/el/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![διάγραμμα πυκνότητας](../../../../../translated_images/el/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![πυκνότητα μάζας σώματος](../../../../../translated_images/el/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![λιγότερο ομαλή μάζα σώματος](../../../../../translated_images/el/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![μάζα σώματος ανά τάξη](../../../../../translated_images/el/bodymass-per-order.9d2b065dd931b928.webp)
