...
```
![maksimalna duljina po redu](../../../../../translated_images/hr/max-length-per-order.e5b283d952c78c12.webp)
...
```
![distribucija cijelog skupa podataka](../../../../../translated_images/hr/distribution-over-the-entire-dataset.d22afd3fa96be854.webp)
...
![distribucija-30bins](../../../../../translated_images/hr/distribution-30bins.6a3921ea7a421bf7.webp)
...
![filtrirani histogram](../../../../../translated_images/hr/filtered-histogram.6bf5d2bfd8253322.webp)
...
![2d grafikon](../../../../../translated_images/hr/2d-plot.c504786f439bd7eb.webp)
...
![raspon krila i status očuvanosti](../../../../../translated_images/hr/wingspan-conservation-collation.4024e9aa6910866a.webp)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![graf gustoće](../../../../../translated_images/hr/density-plot.675ccf865b76c690.webp)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![gustoća tjelesne mase](../../../../../translated_images/hr/bodymass-smooth.d31ce526d82b0a1f.webp)
...
```
![manje glatka tjelesna masa](../../../../../translated_images/hr/less-smooth-bodymass.10f4db8b683cc17d.webp)
...
```
![tjelesna masa po redu](../../../../../translated_images/hr/bodymass-per-order.9d2b065dd931b928.webp)
